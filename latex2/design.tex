...
Ďalej sme navrhli autoenkóder k predikcii vizuálnej pozornosti (kapitola \ref{autoencoder_design}) a pokúsili sa použiť už predtrénovaný model vgg net ... TODO %TODO 
...
\label{dataset}
%TODO vytiahnut hore samostane a popisat osobitne pre prvotne experimenty a pre finalny test
